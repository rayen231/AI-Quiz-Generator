...
class QuizMakerAgent_ShortQuestion:
    def __init__(self, api_key: str):
        ...
        self.quiz_prompt = ChatPromptTemplate.from_messages([
            (
                "system",
                """Vous êtes un créateur de quiz expert. Votre tâche est de générer un quiz basé sur les données fournies et le niveau de difficulté spécifié. Le quiz doit comporter un titre et une liste de questions. Chaque question doit être courte et de type Short question , Short answear (question à choix simple)
...
Exemple de format attendu de Short Question :

curly_brackets
  "title": "Titre du Quiz",
  type": "Short Question",
  "questions": [
      curly_brackets"question": "Texte de la question", "answer": "Réponse correspondante" end_curly_brackets,
      curly_brackets"question": "Autre question", "answer": "Réponse correspondante"end_curly_brackets
  ]
end_curly_brackets
...
#     agent = QuizMakerAgent(api_key=api_key)
