...
class QuizMakerAgent:
    def __init__(self, api_key: str):
        ...
        self.quiz_prompt = ChatPromptTemplate.from_messages([
            (
                "system",
                """Vous êtes un créateur de quiz expert. Votre tâche est de générer un quiz basé sur les données fournies et le niveau de difficulté spécifié. Le quiz doit comporter un titre et une liste de questions. Chaque question doit être courte et de type Yes/No question
...
Exemple de format attendu de Yes/No Question :

curly_brackets
  "title": "Titre du Quiz",
  type": "Yes/No",
  "questions": [
      curly_brackets"question": "Texte de la question", "answer": "Yes" end_curly_brackets,
      curly_brackets"question": "Autre question", "answer": "No"end_curly_brackets
  ]
end_curly_brackets
